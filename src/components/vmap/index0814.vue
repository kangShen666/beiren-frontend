...
const initCesium = () => {
  ...
  // // 172.160.114.55
  // var bd = [
  //   Cesium.Cartesian3.fromDegrees(116.522174, 39.780546, 1),
  //   Cesium.Cartesian3.fromDegrees(116.522628, 39.780012, 1),
  //   Cesium.Cartesian3.fromDegrees(116.522469, 39.779936, 1),
  //   Cesium.Cartesian3.fromDegrees(116.522021, 39.780466, 1),
  //   Cesium.Cartesian3.fromDegrees(116.522174, 39.780546, 1),
  // ];
  // var bd1 = viewer.entities.add({
  ...
  // var ad = [
  //   Cesium.Cartesian3.fromDegrees(116.522628, 39.780012, 1),
  //   Cesium.Cartesian3.fromDegrees(116.523290, 39.779246, 1),
  //   Cesium.Cartesian3.fromDegrees(116.523138, 39.779168, 1),
  //   Cesium.Cartesian3.fromDegrees(116.522469, 39.779936, 1),
  //   Cesium.Cartesian3.fromDegrees(116.522628, 39.780012, 1),
  // ];
  // var ad1 = viewer.entities.add({
  //   name: 'CatmullRomSpline',
  //   polyline: {
  //     positions: ad,
  //     width: 3,
  ...
  // // 172.160.114.54
  // var an1 = [
  //   Cesium.Cartesian3.fromDegrees(116.523212, 39.778908, 1),
  //   Cesium.Cartesian3.fromDegrees(116.522567, 39.778584, 1),
  //   Cesium.Cartesian3.fromDegrees(116.522337, 39.778848, 1),
  //   Cesium.Cartesian3.fromDegrees(116.522979, 39.779173, 1),
  //   Cesium.Cartesian3.fromDegrees(116.523212, 39.778908, 1),
  // ];
  // var an11 = viewer.entities.add({
  //   name: 'CatmullRomSpline',
  //   polyline: {
  //     positions: an1,
  //     width: 3,
  ...
  // var an2 = [
  //   Cesium.Cartesian3.fromDegrees(116.522567, 39.778584, 1),
  //   Cesium.Cartesian3.fromDegrees(116.521867, 39.778228, 1),
  //   Cesium.Cartesian3.fromDegrees(116.521644, 39.778493, 1),
  //   Cesium.Cartesian3.fromDegrees(116.522337, 39.778848, 1),
  //   Cesium.Cartesian3.fromDegrees(116.522567, 39.778584, 1),
  // ];
  // var an22 = viewer.entities.add({
  //   name: 'CatmullRomSpline',
  //   polyline: {
  //     positions: an2,
  //     width: 3,
  ...
  // var an3 = [
  //   Cesium.Cartesian3.fromDegrees(116.521867, 39.778228, 1),
  //   Cesium.Cartesian3.fromDegrees(116.521120, 39.777846, 1),
  //   Cesium.Cartesian3.fromDegrees(116.520890, 39.778109, 1),
  //   Cesium.Cartesian3.fromDegrees(116.521644, 39.778493, 1),
  //   Cesium.Cartesian3.fromDegrees(116.521867, 39.778228, 1),
  // ];
  // var an33 = viewer.entities.add({
  //   name: 'CatmullRomSpline',
  //   polyline: {
  //     positions: an3,
  //     width: 3,
  ...
  // var hyzxn = [
  //   Cesium.Cartesian3.fromDegrees(116.521120, 39.777846, 1),
  //   Cesium.Cartesian3.fromDegrees(116.520112, 39.777324, 1),
  //   Cesium.Cartesian3.fromDegrees(116.519875, 39.777606, 1),
  //   Cesium.Cartesian3.fromDegrees(116.520890, 39.778109, 1),
  //   Cesium.Cartesian3.fromDegrees(116.521120, 39.777846, 1),
  // ];
  // var hyzxn1 = viewer.entities.add({
  //   name: 'CatmullRomSpline',
  //   polyline: {
  //     positions: hyzxn,
  //     width: 3,
  ...
  //   }
  // });
  // viewer.zoomTo(hyzxn1);
  // // 172.160.114.56
  // var bb1 = [
  //   Cesium.Cartesian3.fromDegrees(116.521992, 39.780504, 1),
  //   Cesium.Cartesian3.fromDegrees(116.521288, 39.780142, 1),
  //   Cesium.Cartesian3.fromDegrees(116.521142, 39.780303, 1),
  //   Cesium.Cartesian3.fromDegrees(116.521854, 39.780665, 1),
  //   Cesium.Cartesian3.fromDegrees(116.521992, 39.780504, 1),
  // ];
  // var bb11 = viewer.entities.add({
  //   name: 'CatmullRomSpline',
  //   polyline: {
  //     positions: bb1,
  //     width: 3,
  ...
  // var bb2 = [
  //   Cesium.Cartesian3.fromDegrees(116.521288, 39.780142, 1),
  //   Cesium.Cartesian3.fromDegrees(116.520565, 39.779774, 1),
  //   Cesium.Cartesian3.fromDegrees(116.520433, 39.779934, 1),
  //   Cesium.Cartesian3.fromDegrees(116.521142, 39.780303, 1),
  //   Cesium.Cartesian3.fromDegrees(116.521288, 39.780142, 1),
  // ];
  // var bb22 = viewer.entities.add({
  //   name: 'CatmullRomSpline',
  //   polyline: {
  //     positions: bb2,
  //     width: 3,
  ...
  // var bb3 = [
  //   Cesium.Cartesian3.fromDegrees(116.520565, 39.779774, 1),
  //   Cesium.Cartesian3.fromDegrees(116.519809, 39.779389, 1),
  //   Cesium.Cartesian3.fromDegrees(116.519672, 39.779557, 1),
  //   Cesium.Cartesian3.fromDegrees(116.520433, 39.779934, 1),
  //   Cesium.Cartesian3.fromDegrees(116.520565, 39.779774, 1),
  // ];
  // var bb33 = viewer.entities.add({
  //   name: 'CatmullRomSpline',
  //   polyline: {
  //     positions: bb3,
  //     width: 3,
  ...
  //viewer.entities.add({
  //     position: Cesium.Cartesian3.fromDegrees(116.52205394269407,39.78055783849925, 3),
  ...
  //  viewer.entities.add({
  //     position: Cesium.Cartesian3.fromDegrees(116.52205919649724,39.78056007406701, 3),
  //     model: {
  //       uri: '/model/jc.glb',
  //       scale:1
  //     }
  ...
  //  viewer.entities.add({
  //     position: Cesium.Cartesian3.fromDegrees(116.52206228970584,39.780562952539846, 3),
  //     model: {
  //       uri: '/model/jc.glb',
  //       scale: 1
  //     }
  ...
  // // 检测屏幕分辨率
  // const is4KResolution = window.matchMedia('(width: 11520px) and (height: 2160px)').matches;
  // alert(is4KResolution)
  // 根据分辨率飞向不同位置
  ...
  // viewer.camera.flyTo({
  //   destination: Cesium.Cartesian3.fromDegrees(116.515382, 39.777405, 230.0), // 设置相机的飞行高度
  //   orientation: {
  //     heading: Cesium.Math.toRadians(58), // 朝北
  //     pitch: Cesium.Math.toRadians(-30), // 向下45度
  //     roll: 0,
  //   },
  //   duration: 3.0,
  // });
...
const AreaManager = {
  // 存储区域数据到localStorage
  storeAreas: async function () {
    const response = await fetch("/outgaodidian.json");
    const areas: HotspotEntity[] = await response.json();
    console.log(areas, "111111111111111111");
    localStorage.setItem("cesiumAreas", JSON.stringify(areas));
    return areas;
  },

  // 从存储中获取所有区域
  getStoredAreas: function () {
    const areas = localStorage.getItem("cesiumAreas");
    return areas ? JSON.parse(areas) : [];
  },
  // 获取ID到区域的映射表，提高多次查询效率
  getAreaIdMap: function () {
  ...
  getAreaById: function (id) {
    return this.getAreaIdMap().get(id);
  },

  // 根据ID数组获取多个区域
  getAreasByIds: function (ids) {
    if (!Array.isArray(ids) || ids.length === 0) return [];

    const areaMap = this.getAreaIdMap();
    const validAreas = [];
...
function showArea(viewer, area, color = Cesium.Color.RED) {
  if (!area) {
    console.error("Invalid area object");
    return null;
  }

  // 创建多边形坐标点（添加高度值）
  const positions = area.coords.map(
    (coord) => Cesium.Cartesian3.fromDegrees(coord[0], coord[1], 0), // 高度设为0
  );
...
function showAreaer(viewer, areaName, color = Cesium.Color.RED) {
  // yichu()

  const areas = AreaManager.getStoredAreas();
  ...
  const entity = viewer.entities.add({
    ...
    polygon: {
      ...
      outline: true, // 是否显示轮廓
      outlineColor: Cesium.Color.RED.withAlpha(0.01), // 轮廓颜色（稍深的灰色）
      outlineWidth: 0.1, // 轮廓宽度（减细以更 subtle）
      clampToGround: true, // 强制贴地
      height: 0.3, // 多边形高度（可选）
      extrudedHeight: 0.3, // 拉伸高度（可选，设为0表示不拉伸）
    },
  });
...
// 根据ID显示特定区域，先移除其他所有区域
function showAreaById(viewer, areaId, color = Cesium.Color.RED) {
  // 先清除所有已显示的区域
  clearAllAreas(viewer);

  if (!Array.isArray(areaId)) {
    console.error("Input must be an array of area IDs");
    return [];
  }

  if (areaId.length === 0) {
    console.warn("No area IDs provided");
    return [];
  }

  // 获取有效区域并显示
  const areas = AreaManager.getAreasByIds(areaId);
  const entities = areas.map((area) => showArea(viewer, area, color));
...
let danquanbu = (id) => {
  AreaManager.init();
  showAreaById(viewer, id);
};

// 清除所有区域显示
function clearAllAreas(viewer) {
  const areas = AreaManager.getStoredAreas();
  areas.forEach((area) => {
    const entity = viewer.entities.getById(area.id);
    if (entity) {
      viewer.entities.remove(entity);
    }
  });
...
// 独立出来的显示所有区域函数
function showAllAreas(viewer) {
  const areas = AreaManager.getStoredAreas();
  return areas.map((area) => showAreaer(viewer, area.name));
}
// 独立出来的移除区域函数
function removeArea(viewer, areaName) {
  const entities = viewer.entities.values;
  for (let i = 0; i < entities.length; i++) {
    const entity = entities[i];
    if (entity.name === areaName) {
      viewer.entities.remove(entity);
      return true;
    }
  }
...
// 独立出来的移除所有区域函数
function removeAllAreas(viewer) {
  const areas = AreaManager.getStoredAreas();
  let removedCount = 0;

  areas.forEach((area) => {
    if (removeArea(viewer, area.name)) {
      removedCount++;
    }
  });
...
116.5215705064314, 39.781055933324545,
  ...
  const ERvideoEntities = [
    ...
    //     116.52062708202547, 39.7783663961797,
    //     116.52265925620735, 39.77940268666997,
    //     116.5228294591928, 39.779203868552564,
    //     116.52079963785323, 39.77816894888412,
    //   ],
    //   materialRef: trailer30Ref,
    //   height: 0.3,
    //   rotation: Cesium.Math.toRadians(0),
    //   stRotation: Cesium.Math.toRadians(148),
    //   streamUrl: "http://172.160.114.20:54321/stream/beilu1/channel/xt1/webrtc",
    //   visible: !e,
    //   // x: -2191723.666249449, y: 4392008.683150505, z: 4059415.7693740134, pitch: -0.9084787904995633, heading: 2.565952366580132
    //   x: -2191815.6522279247, y: 4391835.2837457955, z: 4059282.553946947, pitch: -0.4108346220430783, heading: 4.137296743055876
    // },

    // {
    //   id: "q32",  //ab连廊
    //   hierarchy: [
    //     116.5202964835193, 39.77892921112613,
    //     116.52226751690735, 39.77994485210531,
    //     116.52237349398362, 39.779782016417045,
    //     116.52042422620553, 39.77878539921352,
    //   ],
    //   materialRef: trailer32Ref,
    //   height: 4,
    //   rotation: Cesium.Math.toRadians(0),
    //   stRotation: Cesium.Math.toRadians(-32),
    //   streamUrl: "http://172.160.114.20:54321/stream/beilu1/channel/ABLL/webrtc",
    //   visible: !e,
    //   // x: -2191723.666249449, y: 4392008.683150505, z: 4059415.7693740134, pitch: -0.9084787904995633, heading: 2.565952366580132
    //   x: -2191820.9604856838, y: 4391834.575637654, z: 4059234.559860818, pitch: -0.27083724298724654, heading: 4.107768337758104
    // },

    // {
    //   id: "q33",  //生态连廊
    //   hierarchy: [
    //     116.52072999029316, 39.7782089540438,
    //     116.52062094532735, 39.7781473592867,
    //     116.52093209446181, 39.777759123298566,
    //     116.5206214008671, 39.77814929378799,
    //     116.51963521076807, 39.779316339563096,
    //     116.51974795937888, 39.779379870962835,
    //     // 116.5202964835193, 39.77892921112613,
    //     // 116.52226751690735, 39.77994485210531,
    //     // 116.52237349398362, 39.779782016417045,
    //     // 116.52042422620553, 39.77878539921352,
    //   ],
    //   materialRef: trailer33Ref,
    //   height: 10,
    //   rotation: Cesium.Math.toRadians(0),
    //   stRotation: Cesium.Math.toRadians(58),
    //   streamUrl: "http://172.160.114.20:54321/stream/beilu1/channel/STLL/webrtc",
    //   visible: !e,
    //   // x: -2191723.666249449, y: 4392008.683150505, z: 4059415.7693740134, pitch: -0.9084787904995633, heading: 2.565952366580132
    //   // x: -2191815.6522279247, y: 4391835.2837457955, z: 4059282.553946947, pitch: -0.4108346220430783, heading: 4.137296743055876
    //   x: -2191761.4811783056, y: 4392133.140298608, z: 4059244.0363749503, pitch: -1.4823009013065729, heading: 1.0003452599215752
    // },

    // {
    //   id: "q34",  //报告厅
    //   hierarchy: [
    //     116.52017279017355, 39.778604305729324,
    //     116.52058125184956, 39.77811606561661,
    //     116.51997679512644, 39.77779327785436,
    //     116.51955567813866, 39.77828047056813,
    //   ],
    //   materialRef: trailer34Ref,
    //   height: 4,
    //   rotation: Cesium.Math.toRadians(0),
    //   stRotation: Cesium.Math.toRadians(58),
    //   streamUrl: "http://172.160.114.20:54321/stream/beilu1/channel/BGT/webrtc",
    //   visible: !e,
    //   // x: -2191723.666249449, y: 4392008.683150505, z: 4059415.7693740134, pitch: -0.9084787904995633, heading: 2.565952366580132
    //   x: -2191710.988250296, y: 4392171.035962128, z: 4059230.2957789996, pitch: -1.4823009031811032, heading: 1.0003452928497323
    // },

    // {
    //   id: "q35",  //登录厅
    //   hierarchy: [
    //     116.51973260394631, 39.77918800528801,
    //     116.51995881756147, 39.77892034034243,
    //     116.5195533792774, 39.778694240462926,
    //     116.51931584404298, 39.77899565612163,
    //   ],
    //   materialRef: trailer35Ref,
    //   height: 10,
    //   rotation: Cesium.Math.toRadians(0),
    //   stRotation: Cesium.Math.toRadians(58),
    //   streamUrl: "http://172.160.114.20:54321/stream/beilu1/channel/DT/webrtc",
    ...
    //   // x: -2191723.666249449, y: 4392008.683150505, z: 4059415.7693740134, pitch: -0.9084787904995633, heading: 2.565952366580132
    //   // x: -2191815.6522279247, y: 4391835.2837457955, z: 4059282.553946947, pitch: -0.4108346220430783, heading: 4.137296743055876
    //   x: -2191700.6561561176, y: 4392136.778710673, z: 4059272.9410860585, pitch: -1.482300897363483, heading: 1.0003451906568372
    // },

    // {
    //   id: "q8",
    //   hierarchy: [
    //     116.52194803716262, 39.78080582458128,
    //     116.52198101700645, 39.78082608955248,
    //     116.52343841226761, 39.77913069577816,
    //     116.52339163557383, 39.77897603139924,
    //     116.52325720224522, 39.7789090067723,
    //     116.52226690510733, 39.78008078060612,
    //     116.52173327400406, 39.78069932017724,
    //   ],
    //   materialRef: trailer8Ref,
    //   height: 0.1,
    //   rotation: Cesium.Math.toRadians(0),
    //   stRotation: Cesium.Math.toRadians(58.3),
    //   streamUrl: "http://172.160.114.20:54321/stream/beilu1/channel/yyAd1/webrtc",
    //   visible: !e,
    ...
    //   id: "q15",
    //   hierarchy: [
    //     116.51957977595256, 39.77959051698235,
    //     116.5217428192033, 39.78071125684541,
    //     116.5219959074947, 39.780409115209736,
    //     116.51981621286212, 39.77930108733048
    //   ],
    //   materialRef: trailer15Ref,
    //   height: 0.2,
    //   rotation: Cesium.Math.toRadians(0),
    //   stRotation: Cesium.Math.toRadians(-32),
    //   streamUrl: "http://172.160.114.20:54321/stream/beilu1/channel/yyBb3/webrtc",
    //   visible: !e,
    //   x: -2191748.802947443, y: 4392186.225688886, z: 4059595.5232176734, pitch: -1.1230293953163293, heading: 2.56627419000521
    // },
    ...
    //   id: "q18",
    //   hierarchy: [
    //     // 116.52109889417112, 39.77779197510737,
    //     // 116.52080641637357, 39.77813394829872,
    //     // 116.5229587554641, 39.77930667524107,
    //     // 116.52326751494935, 39.77889229743367,

    //     116.52338767835818, 39.778978169091864,
    //     116.52350897038734, 39.77897228804818,
    //     116.52338767835818, 39.778978169091864,
    //     116.5210877653023, 39.77779523877581,
    //     116.520839544942, 39.7781791422585,
    //     116.52293529142355, 39.77923714929478,
    //     116.52290301586113, 39.77929937477791,
    //     116.52293802847247, 39.77923847159088,
    //     116.5232969223162, 39.7792929016666,
    //     116.52321757324165, 39.779390541531306,
    //     116.52343109489273, 39.779132598256254

    //   ],
    //   materialRef: trailer11Ref,
    //   height: 2.2,
    //   rotation: Cesium.Math.toRadians(30),
    //   stRotation: Cesium.Math.toRadians(148),
    //   streamUrl: "http://172.160.114.20:54321/stream/beilu1/channel/yyAn3/webrtc", // 这个点位没有视频流
    //   visible: !e,
    //   x: -2191748.802947443, y: 4392186.225688886, z: 4059595.5232176734, pitch: -1.1230293953163293, heading: 2.56627419000521
    // },
    // {
    ...
    //     116.52007111572057, 39.77727869185514,
    //     116.5197697897273, 39.77762037327544,
    //     116.51956140506883, 39.77766583459727,
    //     116.5197697897273, 39.77762037327544,
    //     116.52085017852413, 39.77816538295369,
    //     116.52108841056453, 39.77779521108837,
    //     116.52114385613343, 39.777778772832406,
    //     116.52108841056453, 39.77779521108837,
    //   ],
    //   materialRef: trailer17Ref,
    //   rotation: Cesium.Math.toRadians(30),
    //   stRotation: Cesium.Math.toRadians(148),
    //   height: 2.2,
    //   streamUrl: "http://172.160.114.20:54321/stream/beilu1/channel/hyzxn59/webrtc", // 这个点位没有视频流
    //   visible: !e,
    //   x: -2191748.802947443, y: 4392186.225688886, z: 4059595.5232176734, pitch: -1.1230293953163293, heading: 2.56627419000521
    // },
  ];
  ...
  const SANvideoEntities = [
    ...
    //   x: -2191722.63450926,
    //   y: 4392019.620598458,
    //   z: 4059229.2750350097,
    //   pitch: -1.0113281220614851,
    //   heading: 4.105215581800335
    ...
    //     116.52061121313045, 39.778369615251734,
    //     116.52264595892827, 39.77940197667817,
    //     116.52282024157525, 39.77919703683782,
    //     116.5207891984327, 39.77816947212912,
    //   ],
    //   materialRef: trailer31Ref,
    //   height: 0.3,
  ...
  const createVideoEntitySafe = (item, entityConfig) => {
    ...
    // setTimeout(() => {
    //   const ent = viewer.entities.getById(item);
    //   // 如果超过 5 秒材质依然是透明占位，说明 playing 事件可能未正常触发，强制切换
    //   if (ent && ent.polygon && videoElement.readyState < 3) {
    //     ent.polygon.material = videoElement;
    //     console.warn(`[QuanJing] 视频流加载超时，强制切换 material: ${item}`);
    //   }
    // }, 5000);
  };
...
let Aguannei1 = () => {
  viewer.camera.flyTo({
    //定位到范围中心点
    destination: {
      // x: -2191808.125210258, y: 4392013.848647462, z: 4059293.415413833,
      // x: -2191772.9121076674,
      // y: 4391992.97576382,
      // z: 4059313.8685631338,
      x: -2191754.929845766,
      y: 4392044.597399739,
      z: 4059402.27628674,
    },
    orientation: {
      // pitch: -1.246890216631376, heading: 2.5640768289781457,

      // pitch: -1.0306519857784604,
      // heading: 2.5575775625026096,
...
//B馆内飞行
// {x: -2191744.6047806283, y: 4391993.833267526, z: 4059353.601985162, pitch: -1.246890224527454, heading: 2.5640768136525454}
let Bguannei = () => {
  viewer.camera.flyTo({
    //定位到范围中心点
    destination: {
...
// {x: -2191760.717799235, y: 4392082.914938301, z: 4059464.065199797, pitch: -1.1230293989957714, heading: 2.5662741850373108}
//AB馆内飞行
let ABguannei = () => {
  viewer.camera.flyTo({
    //定位到范围中心点
...
let waiwei1 = () => {
  viewer.camera.flyTo({
    //定位到范围中心点
    destination: {
      // x: -2192071.5345584922, y: 4391848.491066969, z: 4059190.7394617787,

      x: -2192205.568932753,
      y: 4391860.850801937,
      z: 4059170.6942513045,
    },
    orientation: {
      // pitch: -0.3018831365594834, heading: 4.891699137455037,
      pitch: -0.2941603561362487,
      heading: 4.88684488463228,
      // heading: testHeading,//左右方向
      // pitch: testPitch, //上下方向
      roll: 0.0,
    },
...
const CRUISE_ROUTES = {
  ...
  entity2: { name: "A馆南侧", views: ["An", "Ab", "Bdn", "Bdz", "Bdb","Cn", "Cz", "Cb", "xuting1", "xuting2"] },
  entity3: { name: "B馆南侧", views: ["Bdn", "Bdz", "Bdb", "Cn", "Cz", "Cb", "xuting1", "xuting2", "An", "Ab"] },
  entity4: { name: "B馆中间", views: ["Bdz", "Bdb", "Cn", "Cz", "Cb","xuting1", "xuting2", "An", "Ab", "Bdn"] },
  entity5: { name: "B馆北侧", views: ["Bdb", "Cn", "Cz", "Cb", "xuting1", "xuting2", "An", "Ab", "Bdn", "Bdz"] },
  entity11: { name: "A馆序厅一楼", views: ["xuting1", "xuting2", "An", "Ab", "ABLL", "Bdn", "Bdz", "Bdb", "STLL"] },
  entity16: { name: "A馆序厅二楼", views: ["xuting2", "An", "Ab", "ABLL", "Bdn", "Bdz", "Bdb", "STLL", "xuting1"] },
  entity19: { name: "生态连廊", views: ["STLL", "xuting1", "xuting2", "An", "Ab", "ABLL", "Bdn", "Bdz", "Bdb"] },
  entity20: { name: "AB馆连廊", views: ["ABLL", "Bdn", "Bdz", "Bdb", "STLL", "xuting1", "xuting2", "An", "Ab"] },
  entity21: { name: "C馆南侧", views: ["Cn"] },
  entity22: { name: "C馆中间", views: ["Cz"] },
  entity23: { name: "C馆北侧", views: ["Cb"] },
};
...
const getRadarDatarc = () => {
  ...
  const websocket = new WebSocket("ws://172.160.114.28:8123");
...
// 让父组件的类型可以拿到
// export interface VMapExposed {
//   addHotspot: (hotspotList: HotspotEntity[]) => void;
//   addHotspots: (hotspotList: HotspotEntity[]) => void;
//   disableHotspotClick: () => void;
//   removeHotspotsByIds: (entityIds: string[]) => void;
//   createVideoFusion: () => void;
//   cleanVideoFusion: () => void;
//   QuanJing: () => void;
//   FlightFn: (params: TreePoint) => void;
//   loadModel: (params: string) => void;
//   click_draw_polygon_fn: () => void;
//   changeMark: () => void;
//   test1: () => void;
//   quanbu: () => void;
//   yichu: () => void;
...
//   waiwei: () => void;
//   waiwei1: () => void;
//   stopCruise: (id: any) => void;
//   clearResources: (vdo: any) => void;
//   setEntityVisibility: (id: any) => void;
//   removeurl: () => void;
//   getRadarDatarc: () => void;
//   getshengtailianlang: () => void;
//   getbaogaoting: () => void;
//   getxuting: () => void;
//   closeAllWebSockets: () => void;
//   shengtailianlang: () => void;
//   loadModelById: () => void;
//   removeModelById: (e: any) => void;
//   // 其他暴露的方法...
// }
</script>
