...
const VIEWPORT_TYPE_MAP: Record<string, ViewportType> = {
  ...
  'false': 'small', //小屏 默认
  '1': 'san',  // 5760x1080
  '3': 'middle',  // 5120x960  北人三联屏
  '4': 'center',  // 3840x1080   财富中心18
};
...
const FLY_CONFIGS: Record<string, Partial<Record<ViewportType, FlyToConfig>>> = {
  ...
  Aguannei: {
    ...
    middle: { destination: { x: -2191769.3017378477, y: 4392004.948745722, z: 4059350.458073908 }, orientation: { pitch: -0.9860474659524856, heading: 2.586916626704422, roll: 0.0 } },
    center: { destination: { x: -2191769.3017378477, y: 4392004.948745722, z: 4059350.458073908 }, orientation: { pitch: -0.9860474659524856, heading: 2.586916626704422, roll: 0.0 } },
  },
  Bguannei: {
    ...
    middle: { destination: { x: -2191702.2003192166, y: 4391997.539540619, z: 4059394.7037824634 }, orientation: { pitch: -0.9860474754515951, heading: 2.586916617814014, roll: 0.0 } },
  ...
  Qguannei: {
    ...
    middle: { destination: { x: -2191682.4608273576, y: 4392443.805805932, z: 4058867.8177311732 }, orientation: { pitch: -0.2364970179878283, heading: 0.3922481473302266, roll: 0 }, duration: 3 },
    center: { destination: { x: -2191682.4608273576, y: 4392443.805805932, z: 4058867.8177311732 }, orientation: { pitch: -0.2364970179878283, heading: 0.3922481473302266, roll: 0 }, duration: 3 },
  },
  ximian: {
  ...
  // 西广场
  xiguangchang: {
    big: { destination: { x: -2191657.9384788633, y: 4392043.221343086, z: 4059116.3404027424 }, orientation: { pitch: -0.44190701208566807, heading: 5.729030297364806, roll: 0.0 } },
    small: { destination: { x: -2191695.1914906153, y: 4392065.850788558, z: 4059092.426385657 }, orientation: { pitch: -0.3243491626708854, heading: 5.638998730755515, roll: 0.0 } }
  },
  // 初始飞行视角
  initStart: {
    big: {
